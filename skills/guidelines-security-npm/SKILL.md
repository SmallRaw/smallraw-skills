...
- Installing needs `--ignore-scripts` merely to become askable, so settle it while the user is present rather than mid-run; a hook confirm cannot be pre-satisfied in conversation.
